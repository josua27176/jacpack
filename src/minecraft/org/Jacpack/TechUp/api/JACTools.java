...
public class JACTools {
	...
	public static int getBlockIdOnSide(World var0, int var1, int var2, int var3, ForgeDirection var4)
	{
		return var0.getBlockId(getXOnSide(var1, var4), getYOnSide(var2, var4), getZOnSide(var3, var4));
	}

	public static Material getBlockMaterialOnSide(World world, int x, int y, int z, ForgeDirection dir)
	{
	...
	public static Vector<Integer> getBlockLocationOnSide(Vector<Integer> vec, ForgeDirection dir)
	{
		int[] dirs = {vec.get(0), vec.get(1), vec.get(2)};
		dirs[0] += dir.offsetX;
		dirs[1] += dir.offsetY;
		dirs[2] += dir.offsetZ;
