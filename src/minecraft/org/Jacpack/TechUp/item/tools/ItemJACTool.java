...
public class ItemJACTool extends Item {
	    ...
	    protected ItemJACTool(int par1, int par2, EnumToolMaterial par3EnumToolMaterial, Block[] par4ArrayOfBlock)
	    {
	        super(par1);
	        ...
	        this.setCreativeTab(CreativeTabsHandler.tabTechUpI);//CreativeTabs.tabTools);
