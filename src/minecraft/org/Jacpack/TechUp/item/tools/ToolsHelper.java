...
public class ToolsHelper {
	...
	public static EnumToolMaterial JACSteelTool = EnumHelper.addToolMaterial("JAC_Steel_Tool", 3, 351, 8.0F, 2, 14);
	
	public static EnumToolMaterial JACCopperTool = EnumHelper.addToolMaterial("JAC_Cooper_Tool", 3, 351, 8.0F, 2, 14);
	
	public static EnumToolMaterial JACSilverTool = EnumHelper.addToolMaterial("JAC_Silver_Tool", 3, 351, 8.0F, 2, 14);
